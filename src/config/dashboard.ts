...
export const initialWorkers: Worker[] = [
  ...
  },
  {
    ...
    coords: { x: 74, y: 48 },
    timestamp: new Date().toISOString(),
    telemetry: createTelemetry('WARNING', { fallConfidence: 61 }),
...
export const defaultGatewayZoneSettings: Record<FloorId, GatewayZoneSetting> = {
  '1F': {
    anchors: [
      { id: 'BEACON_01', label: 'Safety 01', x: 55, y: 30 },
      { id: 'BEACON_02', label: 'Safety 02', x: 135, y: 32 },
      { id: 'BEACON_03', label: 'Safety 03', x: 135, y: 103 },
      { id: 'BEACON_04', label: 'Safety 04', x: 54, y: 100 },
    ],
  },
  '2F': {
    anchors: [
...
export const beaconAnchors: BeaconAnchor[] = [
  { id: 'BEACON_01', floor: '1F', label: 'Safety 01', x: 55, y: 30 },
  { id: 'BEACON_02', floor: '1F', label: 'Safety 02', x: 135, y: 32 },
  { id: 'BEACON_03', floor: '1F', label: 'Safety 03', x: 135, y: 103 },
  { id: 'BEACON_04', floor: '1F', label: 'Safety 04', x: 54, y: 100 },
  { id: 'BEACON_01', floor: '2F', label: 'Safety 01', x: 55, y: 30 },
  { id: 'BEACON_02', floor: '2F', label: 'Safety 02', x: 135, y: 32 },
  { id: 'BEACON_03', floor: '2F', label: 'Safety 03', x: 135, y: 103 },
  { id: 'BEACON_04', floor: '2F', label: 'Safety 04', x: 54, y: 100 },
  { id: 'BEACON_01', floor: '3F', label: 'Safety 01', x: 55, y: 30 },
  { id: 'BEACON_02', floor: '3F', label: 'Safety 02', x: 135, y: 32 },
  { id: 'BEACON_03', floor: '3F', label: 'Safety 03', x: 135, y: 103 },
  { id: 'BEACON_04', floor: '3F', label: 'Safety 04', x: 54, y: 100 },
  { id: 'BEACON_01', floor: '4F', label: 'Safety 01', x: 55, y: 30 },
  { id: 'BEACON_02', floor: '4F', label: 'Safety 02', x: 135, y: 32 },
  { id: 'BEACON_03', floor: '4F', label: 'Safety 03', x: 135, y: 103 },
  { id: 'BEACON_04', floor: '4F', label: 'Safety 04', x: 54, y: 100 },
