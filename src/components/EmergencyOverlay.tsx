import { Megaphone, ShieldCheck, Siren, Volume2 } from 'lucide-react';
...
export function EmergencyOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-red-950/92 p-4 backdrop-blur-sm" role="alertdialog" aria-modal="true" aria-labelledby="emergency-title">
        ...
        <div className="flex items-start gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 id="emergency-title" className="mt-1 text-3xl font-black tracking-normal sm:text-4xl">
                추락 감지
              </h2>
            </div>
          </div>
